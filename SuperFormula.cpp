...
public:
  ...
  virtual void keyPressed(unsigned char key)
  {
    ...
    if (key == 'Q' || key == 'q')
      ...
      {superFormulaParameters.a = std::min(3.f, superFormulaParameters.a + 0.01f); invalidateMesh = true;}
    else if (key == 'S' || key == 's')
      {superFormulaParameters.b = std::max(0.f, superFormulaParameters.b - 0.01f); invalidateMesh = true;}
    else if (key == 'Z' || key == 'z')
      {superFormulaParameters.b = std::min(3.f, superFormulaParameters.b + 0.01f); invalidateMesh = true;}
    else if (key == 'D' || key == 'd')
      {superFormulaParameters.m = std::max(0.f, superFormulaParameters.m - 0.1f); invalidateMesh = true;}
    else if (key == 'E' || key == 'e')
      {superFormulaParameters.m = std::min(20.f, superFormulaParameters.m + 0.1f); invalidateMesh = true;}
    else if (key == 'F' || key == 'f')
      {superFormulaParameters.n1 = std::max(0.f, superFormulaParameters.n1 - 0.1f); invalidateMesh = true;}
    else if (key == 'R' || key == 'r')
      {superFormulaParameters.n1 = std::min(20.f, superFormulaParameters.n1 + 0.1f); invalidateMesh = true;}
    else if (key == 'G' || key == 'g')
      {superFormulaParameters.n2 = std::max(0.f, superFormulaParameters.n2 - 0.1f); invalidateMesh = true;}
    else if (key == 'T' || key == 't')
      {superFormulaParameters.n2 = std::min(20.f, superFormulaParameters.n2 + 0.1f); invalidateMesh = true;}
    else if (key == 'H' || key == 'h')
      {superFormulaParameters.n3 = std::max(0.f, superFormulaParameters.n3 - 0.1f); invalidateMesh = true;}
    else if (key == 'Y' || key == 'y')
      {superFormulaParameters.n3 = std::min(20.f, superFormulaParameters.n3 + 0.1f); invalidateMesh = true;}
    if (invalidateMesh)
